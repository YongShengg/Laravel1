  ...
  <div class="py-5 text-center">
    ...
    <div class="col-md-12 col-lg-12">
      <h4 class="mb-3">User Info</h4>
        ...
        <div class="row g-3">
          ...
          <div class="col-12">
            ...
            <div class="input-group has-validation">
              <input type="text" class="form-control" id="username" placeholder="" value="{{auth()->user()->name}}" disabled>
        ...
        <hr class="my-4">
        <form id="carHaulingForm" action="{{ route('userBooking.post',auth()->id()) }}" method="POST">
        @csrf
        <div class="row g-3">
          <div class="col-md-6">
